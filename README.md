...
* **Fully Responsive Canvas:** The game dynamically updates boundaries (gameWidth and gameHeight) on window resize events to keep the ducks bouncing perfectly within view.
...
<video src="./assets/gameplay/videos/duckhunt_preview.mp4" controls width="100%"></video>

### In-Game Moments
| Dynamic 2-Duck Spawn | Context-Aware Round Clear |
|---|---|
| ![Two Ducks Spawning](./assets/gameplay/screenshots/Two%20Ducks%20Spawning.png) | ![Hunting Dog Animation](./assets/gameplay/screenshots/Hunting%20Dog%20Animation.png) |
...
│   ├── gameplay/       # README preview assets (videos & screenshots)
...
👉 **[Launch Duck Hunt Live](https://wizm0hit.github.io/DuckHunt/)**
